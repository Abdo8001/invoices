				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='paid_invioces') }}">الفواتير المدفوعه </a></li>
							@endcan
                            @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . $page='unpaid_invioces') }}">الفواتير الغير مدفوعه</a></li>
							@endcan
					...
					<li class="slide">
                        ...
                        @can('تقرير الفواتير')
							...
							@endcan
                            @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . $page='Search_Bycustomer') }}">تقارير العملاء</a></li>
                           @endcan
						</ul>
					</li>
                     @endcan
